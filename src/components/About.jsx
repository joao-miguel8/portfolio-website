		...
		<>
			<section id="about" className="mx-14 pt-40 mt-20 lg:w-[60rem] min-h-[200px]">
				...
				<p className="mt-4 text-18 leading-8">
					...
					digital marketing. I realized that even the most brilliant website or SaaS product can't reach its full potential without effective marketing. This led me down the path of SEO and PPC.
				</p>
			</section>
		</>
	);
