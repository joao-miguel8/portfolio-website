	...
	return (
		<>
			<section id="about" className="mx-14 pt-40 mt-20 min-h-[200px]">
				...
				<p className="mt-4 text-18 leading-8 montserrat">My journey began in the world of software development, initially fueled by a passion for game development. As I went deeper, I've learned web/software development in my free time and gained some freelance work experience.</p>
