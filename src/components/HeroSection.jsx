				...
				<div className="flex w-full ">
					<div className="mx-auto">
						<div className="-mt-2 flex flex-col items-center">
							<img src={ProfileIMG} alt="image of joão" className="inline-block bg-white bg-[#cddff1] p-4  w-80 rounded-full" />
							<div className="mt-12">
								<h2 className="text-32 font-bold monoSlab text-center">The Serious Face of Marketing</h2>
