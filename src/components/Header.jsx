...
if (toggleTheme === "light") {
  ...
  htmlEle.style.background = "#2E2E2E";
}
...
return (
  <>
<div className="px-2 pt-3 flex items-center justify-between bg-white dark:bg-[#2E2E2E]" >
    ...
    <div className="flex gap-2" >
      <button onClick={handleToggleTheme} className="w-20 flex items-center" >
          ...
          toggleTheme === "light" ? ' border border-dashed border-[#1A96C6] text-[#1A96C6]' : null ,
          "w-full", "p-2", "text-[#1A96C6] dark:text-[#1A96C6]")}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
          </svg>

          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={classNames(toggleTheme === 'dark' ? 'border border-dashed border-[#1A96C6] text-[#1A96C6]' : null , "w-full", "p-2", "text-[#1A96C6]")}>
