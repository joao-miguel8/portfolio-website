			...
			<div className="mx-4">
				...
				<motion.div animate={{ x: 80, y: 0 }} className="mt-6 relative -left-20">
					...
					<div className="pb-8 flex flex-col items-center">
						<div className="flex gap-2 max-[280px]:flex-col max-[280px]:items-center">
							<span className="span font-bold text-12 text-black dark:text-white montserrat">E-MAIL</span>
							{/* email link */}
							<a
								href="#"
								pattern="^((https?|ftp)\://((\[?(\d{1,3}\.){3}\d{1,3}\]?)|(([-a-zA-Z0-9]+\.)+[a-zA-Z]{2,4}))(\:\d+)?(/[-a-zA-Z0-9._?,'+&amp;%$#=~\\]+)*/?)$"
								className="text-12 text-[#1fb3ed] hover:text-[#1283b0] dark:text-[##1fb3ed] dark:hover:text-[#1283b0] robotoMono transition ease-in-out duration-300">
								blahblahblah@gmail.com
							</a>
						</div>

						<div className="mt-2 right-10 flex gap-2 items-center align-bottom ">
							{/* Github link */}
							<a href="https://github.com/joao-miguel8" target="_blank">
								<svg className="w-5 h-5 fill-[#1A96C6] hover:fill-[#0d688c] transition ease-in-out duration-300" id="Layer_1" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<g>
										<path
											clip-rule="evenodd"
							...
							{/* Linkedin Link */}
							<a href="https://www.linkedin.com/in/jo%C3%A3omigueltech/" target="_blank">
								<svg className="w-5 h-5 fill-[#1A96C6] hover:fill-[#0d688c] transition ease-in-out duration-300 " id="linkedin" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
									<title />
